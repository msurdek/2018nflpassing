---
title: "Beer Production Since 2009"
...
## Craft Beer Revolution Continues

Craft beer production grew from 25.7 million barrels in 2009 to 51.4 million in 2018.

Larger breweries, which together produced over 171.2 million barrels of beer in 2009,  accounted for only 131.3 miilion barrels in 2018.

Beer from craft breweries tends to contain more hops and other non-grain ingredients and less grain ingredients such as malt, barley, 

```{r Barrel Line, echo=FALSE}
...
```{r Ingredients, echo=FALSE, warning = FALSE}
